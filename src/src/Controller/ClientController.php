...
class ClientController extends AbstractController
{
     ...
     */
    public function api_index(ClientRepository $clientRepository)
    {
        return $this->json($clientRepository->findAll(), 200, [], ['groups' => 'show_client']);
    }
     ...
     */
    public function api_show(Client $client)
    {
        return $this->json($client, 200, [], ['groups' => 'show_client']);
    }
